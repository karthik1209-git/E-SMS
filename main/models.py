...
class Item(models.Model):
    ...
    LABEL_COLOUR = (
        ...
        ('success', 'success-home'),
        ('primary', 'primary-health'),
        ('info', 'info-mail'),
        ('warning','warning-electric'),
    ...
    instructions = models.CharField(max_length=250,default="type you option")
    ...
    slug = models.SlugField(default="type_model")
    ...
    def get_absolute_url(self):
        return reverse("main:services", kwargs={
            'slug': self.slug
        })
